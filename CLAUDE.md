...
- 船舶智能化 / 智能航运(元启晨星)→ 标杆(**运营域**,两轴互补):`curriculum/案例标杆/船舶方案-架构思路.md`(叙事/拿单)+ `curriculum/案例标杆/船舶方案-技术协议对标卡.md`(技术协议/智控集成:12 把懂行尺子 + 安全四件套 + 分工矩阵,作技术方案对标自检用)
