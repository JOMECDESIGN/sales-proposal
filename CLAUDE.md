...
- 船舶智能化 / 智能航运(元启晨星)→ **核心产品**:`curriculum/案例标杆/船舶-智能船机交互系统-核心产品说明.md`(软硬件一体,智慧驾驶舱/遥控驾驶的升级超集);标杆:`curriculum/案例标杆/船舶方案-架构思路.md`(**运营域**叙事弧);技术底座:`curriculum/案例标杆/船舶-Yog-IOT-技术底座解读.md`(Yog IOT 五层架构 + 三套契约,**底座不变**)
