...
- 船舶智能化 / 智能航运(元启晨星)→ **核心产品**:`curriculum/案例标杆/船舶-智能船机交互系统-核心产品说明.md`(软硬件一体,智慧驾驶舱/遥控驾驶的升级超集);标杆:`curriculum/案例标杆/船舶方案-架构思路.md`(**运营域**叙事弧);技术底座:`curriculum/案例标杆/船舶-Yog-IOT-技术底座解读.md`(Yog IOT 五层架构 + 三套契约,**底座不变**);岸端/远控项目素材:`curriculum/案例标杆/船舶-岸基远控综合平台-中远海运重工舟山-项目素材.md`(招投标级 · 岸基监管/模拟训练/国产化信创/AI 涉控责任边界)
