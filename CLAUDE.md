...
- 船舶智能化 / 智能航运(元启晨星)→ **核心产品**:`curriculum/案例标杆/船舶-智能船机交互系统-核心产品说明.md`(软硬件一体,智慧驾驶舱/遥控驾驶的升级超集);标杆:`curriculum/案例标杆/船舶方案-架构思路.md`(**运营域**叙事弧);技术底座:`curriculum/案例标杆/船舶-Yog-IOT-技术底座解读.md`(Yog IOT 五层架构 + 三套契约,**底座不变**);岸端/远控项目素材:`curriculum/案例标杆/船舶-岸基远控综合平台-中远海运重工舟山-项目素材.md`(招投标级 · 岸基监管/模拟训练/国产化信创/AI 涉控责任边界);控制/自动驾驶维度:`curriculum/案例标杆/船舶-态势感知与远程控制-技术方案素材.md`(自有方案 · 多源融合/风险评分/**分级控制闭环**=核心产品责任边界同源/IMO MASS 演进);设备接入侧:`curriculum/案例标杆/船舶-设备接入接口与协议覆盖-知识卡片.md`(12 类典型设备对象 × 接口 · **4 大类协议映射**[航海数据/工业总线/视频/硬接线 I/O] · **涉控/只读分堆**口径 · §协议表/附录 B/附录 D 同源)
