...
- 跨域架构参考(航空 IMA / 船舶 IBS·IAS / 智能座舱域控制器,三域共通的"集成式架构"模式)→ 标杆:`curriculum/案例标杆/集成系统架构-跨域知识卡片.md`(为船舶与座舱两条线的**招 7 架构地图**提供技术锚点,不对应单一客户案例;**座舱侧注意**:本司汽车线交付=展陈/创新原型,量产域控仅为参照系)
